...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(binding) {
            ...
            val array = arrayOf(ChatMessage(MessageSender.SENDER_BOT, "From the Bot!"),
                ChatMessage(MessageSender.SENDER_USER, "Fron the User!"),
                ChatMessage(MessageSender.SENDER_BOT, "This is a really long message from the bot and it should wrap to the next like, allowing us to test the width of the message box. Hopefully it will work as I intend it to :)"),
                ChatMessage(MessageSender.SENDER_USER, "This is a really long message from the user and it should wrap to the next like, allowing us to test the width of the message box. Hopefully it will work as I intend it to :)"),
            )
